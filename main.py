...
async def lifespan(app: FastAPI):
    ...
    # Banner - Port kommt ausschliesslich aus settings (config.py / .env)
    print(
        f"\n"
        f"  \n"
    ...
    yield
    # Shutdown - HTTP-Clients der Worker werden ueber worker.close() freigegeben,
    # falls ein Worker-Pool in zukuenftigen Stufen eingefuehrt wird.
